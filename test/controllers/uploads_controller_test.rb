...
class UploadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create upload" do
    assert_difference('Upload.count') do
      post uploads_url, params: { upload: { definition: @upload.definition, term: @upload.term } }
    end
  ...
  test "should update upload" do
    patch upload_url(@upload), params: { upload: { definition: @upload.definition, term: @upload.term } }
